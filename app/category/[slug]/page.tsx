    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-100/50 to-stone-50">
      <div className="relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-amber-300/10 rounded-full blur-3xl"></div>
        </div>
                ...
                >
                  <div className="glass-card-hover rounded-3xl overflow-hidden bg-white/60 h-full flex flex-col">
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      <h3 className="text-lg font-semibold text-stone-800 mb-2 line-clamp-2 group-hover:text-amber-700 transition-colors">
                        {product.name}
                      </h3>
